...
public class HostnameResponse extends AbstractCASResponseHandler {
	 ...
	 * @param context
	 */
	public HostnameResponse(CAJServerContext context) {
		super(context, "Hostname request");
	}
	...
	protected void internalHandleResponse(
		...
		String hostname = extractString(response[1], 0, payloadSize, false);
		((CASTransport)transport).setClientHostname(hostname); 
