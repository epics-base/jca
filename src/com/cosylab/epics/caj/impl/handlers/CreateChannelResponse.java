 ...
 * @version $id$
 */
public class CreateChannelResponse extends AbstractCAJResponseHandler {

	/**
	 * @param context
	 */
	public CreateChannelResponse(CAJContext context) {
	...
	protected void internalHandleResponse(
		...
		if (channel != null)
			channel.connectionCompleted(parameter2, dataType, dataCount);
