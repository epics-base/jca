 ...
 *
 *
 * $Id: DBR_TIME_LABELS_Enum.java,v 1.2 2006-08-30 17:25:08 msekoranja Exp $
 *
 * Modification Log:
 ...
 *
 */
public class DBR_TIME_LABELS_Enum extends DBR_LABELS_Enum implements TIME {
  
  protected TimeStamp _stamp;

  public DBR_TIME_LABELS_Enum() {

    this( 1 );

  }

  public DBR_TIME_LABELS_Enum( int count ) {

    this( new short[count] );

  }

  public DBR_TIME_LABELS_Enum( short[] value ) {
    super( value );
  }
