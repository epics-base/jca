 ...
 *
 *
 * $Id: DBR_STS_Byte.java,v 1.2 2006-08-16 15:21:51 msekoranja Exp $
 *
 * Modification Log:
...
public class DBR_STS_Byte extends DBR_Byte implements STS {
  public static final DBRType TYPE= new DBRType("DBR_STS_BYTE",  11, DBR_STS_Byte.class);
  ...
  public DBR_STS_Byte( int count ) {

    this( new byte[count] );

  }

  public DBR_STS_Byte( byte[] value ) {
    super( value );
  }
