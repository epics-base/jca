 ...
 *
 *
 * $Id: DBR_STS_Int.java,v 1.2 2006-08-16 15:21:51 msekoranja Exp $
 *
 * Modification Log:
...
public class DBR_STS_Int extends DBR_Int implements STS {
  public static final DBRType TYPE= new DBRType("DBR_STS_INT", 12, DBR_STS_Int.class);
  ...
  public DBR_STS_Int( int count ) {

    this( new int[count] );

  }

  public DBR_STS_Int( int[] value ) {
    super( value );
  }
