 ...
 * @version $id$
 */
public class AccessRightsResponse extends AbstractCAJResponseHandler {

	/**
	 * @param context
	 */
	public AccessRightsResponse(CAJContext context) {
		super(context, "Access rights");
	}
	...
	protected void internalHandleResponse(
		...
		if (channel != null)
			channel.setAccessRights(parameter2);
