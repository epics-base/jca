 ...
 * @version $id$
 */
public class WriteNotifyResponse extends AbstractCAJResponseHandler {

	/**
	 * @param context
	 */
	public WriteNotifyResponse(CAJContext context) {
		super(context, "Write notify response");
	}
	...
	protected void internalHandleResponse(
		...
		nrr.response(status, dataType, dataCount, null);					
