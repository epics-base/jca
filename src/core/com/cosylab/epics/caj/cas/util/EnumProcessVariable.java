...
public abstract class EnumProcessVariable extends ProcessVariable {
     ...
     * @param eventCallback
     *            event callback, can be <code>null</code>.
     */
    ...
    /**
     * Casts <code>DBR</code> to <code>DBR_TIME_LABELS_Enum</code>, sets labels
     * returned by <code>getEnumLabels()</code> and delegates operation of
     * reading a value to <code>readValue</code> method.
     * 
     ...
     *      gov.aps.jca.cas.ProcessVariableReadCallback)
     */
    protected abstract CAStatus readValue(DBR_TIME_LABELS_Enum value, ProcessVariableReadCallback asyncReadCallback)
            throws CAException;

    /**
     * Casts <code>DBR</code> to <code>DBR_Enum</code> and delegates operation
     * of writing a value to <code>writeValue</code> method.
     * 
     ...
     *
     *         // set status, severity and time here (see readValue method
     *         // example)
     ...
     *      gov.aps.jca.cas.ProcessVariableWriteCallback)
     */
    protected abstract CAStatus writeValue(DBR_Enum value, ProcessVariableWriteCallback asyncWriteCallback)
            throws CAException;
