 ...
 * @version $id$
 */
public class DistributedPerformanceIT {
     ...
     * Sync get test.
     */
    private void internalSyncGetTest(int bulkSize) throws CAException, TimeoutException, InterruptedException {
     ...
     * ASync get test.
     */
    private void internalAsyncGetTest(int bulkSize) throws CAException, TimeoutException, InterruptedException {
     ...
     */
    private void internalSyncGetTestNoBulk(int bulkSize) throws CAException, TimeoutException, InterruptedException {
     ...
     */
    private void internalAsyncGetTestNoBulk(int bulkSize) throws CAException, TimeoutException, InterruptedException {
    ...
    public void testSyncGet() throws CAException, TimeoutException, InterruptedException {
        /*
         * internalSyncGetTest(10); internalSyncGetTest(100);
         * internalSyncGetTest(250); internalSyncGetTest(500);
         * internalSyncGetTest(1000); internalSyncGetTest(2500);
    ...
    public void testAsyncGet() throws CAException, TimeoutException, InterruptedException {
        /*
         * internalAsyncGetTest(10); internalAsyncGetTest(100);
         * internalAsyncGetTest(250); internalAsyncGetTest(500);
         * internalAsyncGetTest(1000); internalAsyncGetTest(2500);
    ...
    public void testSyncGetNoBulk() throws CAException, TimeoutException, InterruptedException {
        /*
         * internalSyncGetTestNoBulk(10); internalSyncGetTestNoBulk(100);
         * internalSyncGetTestNoBulk(250); internalSyncGetTestNoBulk(500);
         * internalSyncGetTestNoBulk(1000); internalSyncGetTestNoBulk(2500);
    ...
    public void testAsyncGetNoBulk() throws CAException, TimeoutException, InterruptedException {
        /*
         * internalAsyncGetTestNoBulk(10); internalAsyncGetTestNoBulk(100);
         * internalAsyncGetTestNoBulk(250); internalAsyncGetTestNoBulk(500);
         * internalAsyncGetTestNoBulk(1000); internalAsyncGetTestNoBulk(2500);
    ...
    public void setUp() throws Exception {
        ...
        // System.setProperty("com.cosylab.epics.caj.CAJContext.event_dispatcher",
