...
public class CAJChannelPutIT {
    ...
    public void testACKSPut() throws CAException, TimeoutException, InterruptedException {
        ...
        /*
         * DBR_STSACK_String val =
         * (DBR_STSACK_String)cchannel.get(DBRType.STSACK_STRING, 1);
         * context.pendIO(3.0); assertEquals(Severity.MINOR_ALARM,
         * val.getAckS());
         * 
         * cchannel.putACKS(Severity.MAJOR_ALARM); context.flushIO();
         * 
         * val = (DBR_STSACK_String)cchannel.get(DBRType.STSACK_STRING, 1);
         * context.pendIO(3.0); assertEquals(Severity.MAJOR_ALARM,
         * val.getAckS());
         */
