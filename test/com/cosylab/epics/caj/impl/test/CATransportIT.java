...
public class CATransportIT {
    ...
    public void testCAConnectorFailedToConnect() {
        try {
            new CAConnector(context).connect(channel, null, null, CAConstants.CA_MINOR_PROTOCOL_REVISION,
    ...
    public void testTransportClosed() throws IOException, InterruptedException {
        ...
        /*
         * try { transport.getRemoteAddress();
         * fail("returning remote address when closed"); } catch
