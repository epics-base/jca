...
public class JCAChannelIT {
    ...
    public void testConnectionListenerNotifications() throws CAException, TimeoutException, InterruptedException {
        ...
        /*
         * ON DESTROY JCA DOES NOT ISSUE DISCONNECT EVENT channel.destroy();
         * 
         * synchronized(cl1) { if (cl1.getNotifications().size() == 1)
         * cl1.wait(3000); }
         * 
         * assertEquals(2, cl1.getNotifications().size()); assertEquals(false,
         * ((ConnectionEvent)cl1.getNotifications().lastElement()).isConnected()
         * );
         */
    }
