 ...
 * @version $id$
 */
public class JCAContextPendPoolFlushIT {
    ...
    public void testAll() throws CAException, TimeoutException, InterruptedException {
        ...
        // TODO JCA returns false here!!!
        /*
         * // put does not count... assertEquals(true, context.testIO());
         * context.pendIO(5.0); assertEquals(true, context.testIO());
         */
        ...
        DBR dbr = channel.get();
        assertTrue(dbr != null);
        // JCA assertEquals(false, context.testIO());
        context.pendIO(3.0);
        // JCA assertEquals(true, context.testIO());
        ...
        // not related to pendIO at all, but require pend_event (to be flushed
        // also)
